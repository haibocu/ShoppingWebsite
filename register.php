...
<tr><td align="center">
<span class="titleforlogin"><br />註冊頁面</span>
</td></tr>
<tr><td align="center">
<div>
<form name="registerform" method="post" action="checkforregister.php">
<table>
<tr>
<td>郵箱地址：</td>
...
<tr>
<td><img src="captcha/code.php" id="captcha" width="100" height="40"/></td>
<td><a href="register.php" onclick="document.getElementById(‘captcha’).src =
document.getElementById(‘captcha’).src + ‘?’ + (new Date()).getMilliseconds()"> 
看不清，換一張</a></td>
</tr>
<tr>
